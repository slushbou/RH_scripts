...
' 2018-10-16 (SHL)  Change retries (/R:) to zero until cause of backup failures can be found.
  strRBC = "ROBOCOPY " & strSourceDir & " " & strDestDirNew & " /MIR /XA:SH /R:0 /W:5 /NP /LOG:" & strBKUPDIR & "Backup_Passport.log"
